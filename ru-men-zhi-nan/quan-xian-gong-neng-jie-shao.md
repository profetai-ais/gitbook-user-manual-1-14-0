...
* 若使用者沒有該功能的 Root 權限，通常無法進入該功能頁面，也無法操作該功能中的物件。



> 注意 : 使用者實際可見與可操作的內容會依 Root 權限與 Object 權限設定而有所不同。若使用者無法看到特定功能或物件，請確認該使用者是否具備對應功能的 Root 權限，以及該物件是否已授予對應的 Object 權限。\
